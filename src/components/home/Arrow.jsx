  ...
  return (
    <>
      <div
        ...
        rounded-full border-none bg-white opacity-0 transition-all duration-300 
        ease-linear hover:bg-gradient-to-r hover:from-[#0f4670] hover:to-[#4ba3e7] hover:text-white xl:group-hover:opacity-100  ${
          direction === "right"
