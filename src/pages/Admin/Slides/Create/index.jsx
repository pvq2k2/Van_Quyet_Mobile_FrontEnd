...
import { createSlidesSchema } from "../../../../helpers/yupSchema";
import { isFileExtension } from "../../../../utils";
import { fetchCreateSlides } from "../../../../redux/slice/slidesSlice";

const SlidesCreate = () => {
  document.title = "Thêm ảnh trình chiếu - Văn Quyết Mobile";
  ...
  const form = useForm({
    ...
    resolver: yupResolver(createSlidesSchema),
  });
  ...
  const handleSubmit = async (value) => {
    ...
    try {
      const res = await dispatch(fetchCreateSlides(formData)).unwrap();
